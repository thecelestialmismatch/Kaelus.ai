# Kaelus — Payments Integrations

Route all AI calls through the Kaelus proxy to enforce SOC 2, HIPAA, and CMMC Level 2 simultaneously across your Payments stack.
