 ...
 *  - Kaelus product (full coverage of all features, verticals, pricing)
 */
...
const FAQ_DB: FaqEntry[] = [
  ...
  },
  {
    ...
    answer:
      "```python\n# Python / LangChain\nclient = OpenAI(\n  base_url='https://gateway.kaelus.online/v1',\n  api_key=os.environ['OPENAI_API_KEY']\n)\n```\n\n```typescript\n// Node.js / TypeScript\nconst openai = new OpenAI({\n  baseURL: 'https://gateway.kaelus.online/v1',\n  apiKey: process.env.OPENAI_API_KEY,\n});\n```\n\nAny OpenAI-compatible client works. Use any model slug (gpt-4o, claude-sonnet-4-6, gemini-flash, llama-3.3...) — Kaelus routes to OpenRouter's 800+ model catalog.",
  },
  {
  ...
  // ── MODEL ACCESS ─────────────────────────────────────────────────────
  {
    ...
    answer:
      "Kaelus provides access to **800+ models via OpenRouter** through a single compliant endpoint:\n- OpenAI: GPT-4o, o3, o1\n- Anthropic: Claude 4.6 Sonnet, Claude 3.5 Haiku\n- Google: Gemini 2.5 Pro/Flash\n- Meta: Llama 3.3 70B\n- Qwen: Qwen3 (including free tiers)\n- Mistral: Large, Codestral\n- 800+ more\n\nAll models, all compliant. Use the model slug as the `model` parameter — Kaelus routes to the right provider automatically.",
  },
  ...
  // ── SUPPORT / CONTACT ────────────────────────────────────────────────
  {
    ...
    answer:
      "**Get in touch:**\n- Website: [kaelus.online](https://kaelus.online)\n- Email: info@kaelus.online\n- Docs: kaelus.online/docs\n- Pricing: kaelus.online/pricing\n\nFor enterprise demos, MSP partnerships, or C3PAO coordination, email directly — we typically respond same day.",
  },
