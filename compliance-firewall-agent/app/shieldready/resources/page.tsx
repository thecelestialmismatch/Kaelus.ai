              ...
              {section.items.map((item) => {
                ...
                return (
                  <a
                    ...
                    className="group bg-slate-900/70 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-5 hover:border-blue-500/30 hover:bg-blue-500/5 transition-all"
                  >
                    <div className="flex items-start gap-3">
                      <Icon size={18} className="text-slate-400 group-hover:text-blue-400 transition-colors shrink-0 mt-0.5" />
