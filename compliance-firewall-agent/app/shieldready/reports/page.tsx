    ...
    <div className="min-h-screen p-6 lg:p-8 max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-8 print:hidden">
        ...
        <div className="flex gap-2">
          <button
            onClick={handlePrint}
            className="flex items-center gap-2 px-4 py-2.5 bg-slate-800 hover:bg-slate-700 rounded-xl text-slate-300 text-sm transition-colors"
          >
            <Printer size={16} />
            Print / PDF
          </button>
      ...
      <div ref={reportRef} className="space-y-6 print:space-y-4">
        {/* Title Block */}
        <div className="bg-slate-900/70 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 print:border-slate-300 print:bg-white">
          <div className="flex items-start justify-between">
            <div>
              <h2 className="text-2xl font-bold text-white print:text-black mb-1">
                SPRS Self-Assessment Report
              </h2>
              <div className="flex items-center gap-4 text-sm text-slate-400 print:text-slate-600 mt-2">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          <div className="bg-slate-900/70 border border-slate-700/50 rounded-2xl p-5 print:border-slate-300">
          ...
          <div className="bg-slate-900/70 border border-emerald-500/20 rounded-2xl p-5 print:border-slate-300">
          ...
          <div className="bg-slate-900/70 border border-red-500/20 rounded-2xl p-5 print:border-slate-300">
        ...
        <div className="bg-slate-900/70 border border-slate-700/50 rounded-2xl overflow-hidden print:border-slate-300">
          <div className="p-5 border-b border-slate-700/50 print:border-slate-300">
              ...
              <tbody>
                {CONTROL_FAMILIES.map((family) => {
                  ...
                  return (
                    <tr
                      key={family.code}
                      className="border-b border-slate-800/50 print:border-slate-200 hover:bg-slate-800/30 transition-colors"
                    >
                      ...
                      <td className="text-center text-slate-300 print:text-black px-3 py-3">{family.controlCount}</td>
        ...
        {/* Disclaimer */}
        <div className="bg-slate-800/30 border border-slate-700/30 rounded-xl p-4 text-xs text-slate-500 print:border-slate-300 print:text-slate-600">
