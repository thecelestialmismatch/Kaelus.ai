...
export function TickerSection() {
  ...
  return (
    <div className="relative bg-white/[0.02] border-t border-b border-white/[0.06] py-3 overflow-hidden">
      <div className="flex gap-12 animate-marquee whitespace-nowrap" style={{ width: "max-content" }}>
        {doubled.map((item, i) => (
          <div key={i} className="flex items-center gap-2 flex-shrink-0 text-slate-500 text-[13px]">
