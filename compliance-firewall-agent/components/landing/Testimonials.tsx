        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {TESTIMONIALS.map((t, i) => (
            <FadeIn key={t.author} delay={i * 0.1}>
              <div className="relative p-8 rounded-[20px] bg-white/[0.02] border border-white/[0.06] hover:bg-white/[0.04] hover:border-white/10 hover:-translate-y-0.5 transition-all duration-300">
                <div className="absolute top-6 right-6 text-[40px] text-white/[0.03] leading-none select-none font-serif">
                  &rdquo;
                </div>
                ...
                <p className="text-sm text-white/55 leading-[1.75] italic mb-4">&ldquo;{t.quote}&rdquo;</p>
                <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-emerald-500/8 border border-emerald-500/20 text-[11px] font-bold text-emerald-400 mb-5">
                  ✓ {t.metric}
                </div>
