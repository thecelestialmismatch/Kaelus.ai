  ...
  return (
    <section className="relative py-32 text-center overflow-hidden bg-[#07070b]">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6">
        <h2 className="text-[clamp(32px,5vw,56px)] font-extrabold tracking-[-1.5px] leading-[1.1] text-white max-w-[720px] mx-auto mb-5">
        ...
        <Link
          href="/signup"
          className="inline-flex items-center gap-2 px-10 py-5 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold rounded-xl transition-all hover:-translate-y-0.5 hover:shadow-[0_8px_32px_rgba(99,102,241,0.4)] text-lg"
        >
