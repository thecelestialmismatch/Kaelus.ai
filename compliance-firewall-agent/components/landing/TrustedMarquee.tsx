...
export function TrustedMarquee() {
  ...
  return (
    <div className="py-16 border-b border-white/[0.04] bg-white/[0.01] overflow-hidden">
      <p className="text-center text-[11px] font-semibold uppercase tracking-[0.2em] text-white/20 mb-8">
