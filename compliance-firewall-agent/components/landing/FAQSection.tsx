  ...
  return (
    <div
      className={`rounded-[14px] overflow-hidden border transition-colors duration-200 ${
        open ? "bg-white/[0.03] border-white/[0.08]" : "bg-white/[0.02] border-white/[0.05]"
      }`}
    >
      <button
          ...
          >
            <div className="px-6 pb-5">
              <div className="pt-3.5 border-t border-white/[0.05]">
                <p className="text-sm text-white/45 leading-[1.75]">{a}</p>
              </div>
            </div>
          </motion.div>
        )}
...
export function FAQSection() {
  ...
  return (
    <section id="faq" className="py-24 md:py-32 bg-[#07070b]">
