...
export function PixelOffice() {
    ...
    return (
        <div className="h-full flex flex-col bg-white rounded-xl border border-slate-200 overflow-hidden">
            {/* Header */}
            <div className="flex items-center justify-between px-5 py-3 border-b border-slate-200 bg-slate-50 backdrop-blur-sm">
            ...
            <div className="flex-1 flex items-center justify-center p-4 overflow-auto bg-slate-50">
                <div className="rounded-lg overflow-hidden border border-slate-200 shadow-2xl shadow-purple-500/5">
                    <canvas
                        ref={canvasRef}
                        className="block"
            ...
            {/* Agent Status Bar */}
            <div className="border-t border-slate-200 bg-slate-50 backdrop-blur-sm px-5 py-3">
                ...
                <div className="grid grid-cols-3 gap-2">
                    {agents.map((agent) => {
                        ...
                        return (
                            <div
                                key={agent.id}
                                className="flex items-center gap-2 px-2.5 py-1.5 rounded-md bg-slate-50 border border-slate-200 hover:border-white/10 transition-all"
                            >
                                <div
