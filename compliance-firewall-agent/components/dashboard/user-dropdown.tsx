    ...
    return (
        <div className="relative w-full" ref={dropdownRef}>
            ...
            >
                ...
                <div className={`text-white/40 transition-transform ${isOpen ? "rotate-180" : ""}`}>
            ...
            {/* Dropdown Menu */}
            {isOpen && (
                <div className="absolute bottom-[calc(100%+8px)] left-0 w-[260px] bg-[#111116] border border-white/[0.08] rounded-xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-200 z-50">
                    ...
                    <div className="px-4 py-3 border-b border-white/[0.06] space-y-2">
                        ...
                        <div className="flex justify-between items-center text-sm">
                            <span className="text-white/50">Reports</span>
                    ...
                    <div className="p-2 space-y-0.5">
                        ...
                        <button className="w-full flex items-center gap-3 px-3 py-2 text-sm text-white/70 hover:bg-white/[0.04] rounded-lg transition-colors">
                        ...
                        <button
                            onClick={onLogout}
                            className="w-full flex items-center gap-3 px-3 py-2 text-sm text-white/70 hover:bg-white/[0.04] rounded-lg transition-colors"
                        >
