  ...
  return (
    <div className="min-h-screen p-6 lg:p-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 mb-8">
        {/* SPRS Gauge */}
        <div className="lg:col-span-1 bg-slate-900/70 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6 flex items-center justify-center">
          <SPRSGauge score={sprs.total} size="sm" />
        </div>

        {/* Stat cards */}
        <div className="lg:col-span-4 grid grid-cols-2 lg:grid-cols-4 gap-3">
          <div className="bg-slate-900/70 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-5">
          ...
          <div className="bg-slate-900/70 backdrop-blur-xl border border-red-500/20 rounded-2xl p-5">
          ...
          <div className="bg-slate-900/70 backdrop-blur-xl border border-emerald-500/20 rounded-2xl p-5">
        ...
        {gaps.map((control, i) => {
          ...
          return (
            <motion.div
              ...
              className="bg-slate-900/70 backdrop-blur-xl border border-slate-700/50 rounded-2xl overflow-hidden"
            >
              <button
              ...
              {isExpanded && (
                <motion.div
                  ...
                  className="border-t border-slate-700/30 px-5 pb-5 pt-4"
                >
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                      <h4 className="text-xs font-semibold text-slate-500 uppercase mb-2">What to do</h4>
                      <p className="text-slate-300 text-sm mb-4">{control.plainEnglish}</p>
