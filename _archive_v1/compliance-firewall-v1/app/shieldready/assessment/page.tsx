...
const _TW_SAFELIST = [
  ...
  "bg-slate-500/20", "text-slate-400", "border-slate-500", "border-slate-500/30",
...
export default function AssessmentPage() {
  ...
  return (
    <div className="flex min-h-screen">
      {/* ── Sidebar ── */}
      <aside className={`w-64 shrink-0 border-r border-slate-700/50 bg-slate-950/50 backdrop-blur-xl p-4 overflow-y-auto hidden lg:block`}>
      ...
      <main className="flex-1 p-6 lg:p-8 overflow-y-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            ...
            className="lg:hidden p-2 bg-slate-800 rounded-xl text-slate-300 hover:text-white"
          >
            <BarChart3 size={20} />
          </button>
        </div>
        ...
        {/* Mobile score bar */}
        <div className="lg:hidden mb-6 flex items-center gap-4 bg-slate-900/70 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-4">
